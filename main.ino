...
// =====================================================
// THRESHOLD SENSOR SUARA
// =====================================================
const int THRESHOLD_BERISIK = 950;
const int THRESHOLD_NORMAL  = 885;

// =====================================================
// INTERVAL WARNING
// =====================================================
const unsigned long warningInterval = 30000; // 30 detik
const unsigned long normalDelay     = 30000;  // normal stabil 3 detik
...
// =====================================================
// HELPER SENSOR TERHUBUNG
// =====================================================
bool isPinTerhubung(int pin, int samples = 100) {
...
void loop() {
  ...
  if (millis() - lastSerial >= 1000) {
    ...
    Serial.printf(
      "Lux:%d | ADC:%d | Berisik:%s | Warning:%s\n",
      lux,
      suara,
      berisik ? "YA" : "TIDAK",
